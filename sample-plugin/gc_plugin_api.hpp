...
struct PluginFunctions {
  ...
  void *(*addEffectProperty)(Effect *effect, PropertyType type,
                             const char *name);
  void *(*getEffectProperty)(PluginEffectRenderContext *renderContext,
                             const char *name);
  int (*getPropertyInt)(void *property);
  double (*getPropertyDouble)(void *property);
  Color (*getPropertyColor)(void *property);
  Vector2DInt (*getPropertyVector2DInt)(void *property);
  bool (*getPropertyBool)(void *property);
  void *(*getPropertyBrush)(void *property);
  Color (*getBrushPixel)(void *brush, int x, int y, int w, int h);
};
