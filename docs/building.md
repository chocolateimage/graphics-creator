...
```bash
# Arch
pacman -S --needed cmake ninja pkgconf qt6-base qt6-svg qt-advanced-docking-system ffmpeg kiconthemes kwidgetsaddons extra-cmake-modules breeze breeze-icons
```
...
1. Install these packages:
   ```bash
   pacboy -S --needed gcc cmake ninja pkgconf qt6-base qt6-svg qt-advanced-docking-system ffmpeg kiconthemes kwidgetsaddons extra-cmake-modules breeze breeze-icons
   ```
