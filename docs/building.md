...
```bash
# Arch
pacman -S --needed cmake ninja qt6-base qt-advanced-docking-system ffmpeg luajit kiconthemes kwidgetsaddons ktexteditor extra-cmake-modules
```
...
1. Install these packages:
   ```bash
   pacboy -S --needed gcc cmake ninja qt6-base qt-advanced-docking-system ffmpeg luajit kiconthemes kwidgetsaddons ktexteditor extra-cmake-modules
   ```
